    ...
    return (
      <div className={styles.feedback}>
        <div className={styles.feedback_container}>
          <p
            className={`${styles.section_title} ${styles.request_selection_title}`}
          >
            Select Your Request
          </p>
          <div
            className={`${styles.section_container} ${styles.request_selection_container}`}
          >
            <div>
              <DropDown
          ...
          <p
            className={`${styles.section_title} ${styles.send_feedback_title}`}
          >
            Send Us Your Feedback
          </p>
          <div
            className={`${styles.section_container} ${styles.experience_rate_container}`}
          >
            <div className={`${styles.section} ${styles.experience_rate}`}>
              <p className={styles.section_subtext}>Rate your experience</p>
              <div
                className={`${styles.content} ${styles.content_experience_rate}`}
              >
          ...
          <p
            className={`${styles.section_title} ${styles.Questionnaire_title}`}
          >
            Questionnaire
          </p>
          <div
            className={`${styles.section_container} ${styles.Questionnaire_left_container}`}
          >
          ...
          <div
            className={`${styles.section_container} ${styles.Questionnaire_right_container}`}
          >
            <div className={styles.Questionnaire_question}>
